...
class PermissionDAO {
     ...
     */
    public function getAllPermissionsRecords() : array {
     ...
     * @throws \Teacher\GivenCode\Exceptions\RuntimeException
     */
    public function createPermission(PermissionDTO $permission) : PermissionDTO {
        ...
        $created_permission = $this->getPermissionById($new_id);
     ...
     * @throws \Teacher\GivenCode\Exceptions\RuntimeException
     */
    public function updatePermission(PermissionDTO $permission) : PermissionDTO {
        ...
        $statement->bindValue(":permissiondescription", $permission->getPermissionDescription(), PDO::PARAM_STR);
        $statement->execute();
        $updated_permission = $this->getPermissionById($permission->getPermissionId());
     ...
     */
    public function deleteObjectPermission(PermissionDTO $permission) : void {
        ...
        $this->deletePermissionRecordById($permission->getPermissionId());
    }
     ...
     * @throws \Teacher\GivenCode\Exceptions\RuntimeException
     */
    public function deletePermissionRecordById(int $permissionid) : void {
        $query =
